...
def test_searchbox_add():
    ...
    assert s.get_cmd_str() == ('slider height="200" label="To what extend you agree" max="10" min="0" showValue="true" '
    'step="1" value="1" valueFormat="current_value is {value}" vertical="true"'), "Test failed"