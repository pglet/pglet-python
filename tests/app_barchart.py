...
def main(page):
    ...
    # Fractions BarChart
    chart1 = BarChart(data_mode='fraction', width='50%', tooltips=True, points=[
        Point(legend='C:', x=20, y=250, x_tooltip='20%', y_tooltip='20 of 250 GB used'),
        Point(legend='D:', x=50, y=250, x_tooltip='50%'),
        Point(legend='E:', x=30, y=250, x_tooltip='30%')
    ])

    # Percentage BarChart
    chart2 = BarChart(data_mode='percentage', width='30%', tooltips=True, points=[
