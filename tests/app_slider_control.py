...
def sliders():
  return Stack(width='50%', controls=[
    Stack(controls=[
        ...
        Slider(label='Slider with formatted value', show_value=True, value=4, value_format='{value}%'),
    ...
    Stack(horizontal=True, height='200px', controls=[
        ...
        Slider(vertical=True, label='Slider with formatted value', show_value=True, value=4, value_format='{value}%'),
